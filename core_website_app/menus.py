...
from core_website_app.settings import DISPLAY_PRIVACY_POLICY_FOOTER, DISPLAY_TERMS_OF_USE_FOOTER, \
    DISPLAY_CONTACT_FOOTER, DISPLAY_HELP_FOOTER, DISPLAY_RULES_OF_BEHAVIOR_FOOTER
...
if DISPLAY_RULES_OF_BEHAVIOR_FOOTER:
    Menu.add_item(
        "footer",
        MenuItem("Rules of Behavior", reverse("core_website_app_rules_of_behavior"), icon="balance-scale", weight=1004)
    )

# Admin menus for website app
website_children = (
    MenuItem("Privacy Policy", reverse("admin:core_website_app_privacy"), icon="user-secret"),
    MenuItem("Terms of Use", reverse("admin:core_website_app_terms"), icon="file-alt"),
    MenuItem("Help Page", reverse("admin:core_website_app_help"), icon="question-circle"),
