...
admin_urls = [
    re_path(r'^user-requests$', admin_views.user_requests, name='core_website_app_user_requests'),
    re_path(r'^accept_request', admin_ajax.accept_request, name="core_website_app_accept_user_request"),
    re_path(r'^deny_request', admin_ajax.deny_request, name="core_website_app_deny_user_request"),
    re_path(r'^request_count', admin_ajax.account_request_count, name="core_website_app_request_count"),

    re_path(r'^contact-messages$', admin_views.contact_messages, name='core_website_app_contact_messages'),
    re_path(r'^remove_message', admin_ajax.remove_message, name="core_website_app_remove_contact_message"),
    re_path(r'^message_count', admin_ajax.contact_message_count, name="core_website_app_message_count"),

    re_path(r'^privacy-policy$',
            WebPageView.as_view(api=privacy_policy_api,
    ...
    re_path(r'^terms-of-use$',
            WebPageView.as_view(api=terms_of_use_api,
    ...
    re_path(r'^help$',
            WebPageView.as_view(api=help_api,
