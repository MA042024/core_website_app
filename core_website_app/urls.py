...
urlpatterns = [
    re_path(r'^account-request', user_views.request_new_account, name='core_website_app_account_request'),
    ...
    re_path(r'^rules-of-behavior', user_views.rules_of_behavior, name='core_website_app_rules_of_behavior'),
